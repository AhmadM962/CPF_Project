...
•	Write in Markdown (.md) instead of Word when possible (easier to edit + version).
✅ /design/
•	Screenshots of prototype, Figma exports, UI notes
•	Color palette, typography rules
✅ /data/
•	Small datasets and CSVs
•	If the dataset gets big later, you keep only samples here and store the full dataset elsewhere (Drive/Kaggle) and link it in README.md.
✅ /research/
